...
This project serves as an educational example of creating an API using Generic Views in Django. The project is authored by Marselle. You can contact the author [here](https://instagram.com/marselle.naz).
...
1. Clone the repository:
    ...
    ```bash
    git clone git@github.com:Huksii/Generic-Api-Project.git
    ```
...
The project author, Marselle, is available on [Instagram](https://instagram.com/marselle.naz). Feel free to reach out to him for feedback, questions, or additional information.
